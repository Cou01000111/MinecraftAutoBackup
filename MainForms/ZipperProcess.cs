...
namespace Zipper {
    public static class ZipperProcess {
        public static string tmpPath;
        public static int successCount = 0;
        public static int errorCount = 0;
        public static int skipCount = 0;
        public static WaitDialog wait;
        private static Logger logger = new Logger("Zipper",".\\logs\\Zipper.txt",3);
        public static void MainProcess(int args) {
